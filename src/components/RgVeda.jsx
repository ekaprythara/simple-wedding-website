  ...
  return (
    <section className="w-5/6 mx-auto">
      <div className="text-center flex flex-col justify-center items-center w-10/12 py-10 mx-auto">
        ...
        <p className="font-platypi text-sm md:text-base lg:text-lg text-[#988568]">
        ...
        <div className="w-48 md:w-52 lg:w-56 pt-10 flex flex-col gap-2">
          <hr className="border border-[#988568]" />
          <p className="font-platypi text-base md:text-lg lg:text-xl text-[#988568] flex items-center justify-center">
            <span className="me-3">
              <GiBlackBook size={28} />
            </span>
            Rg Veda X.85.42
